  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @run_forward$async_dispatch_18_matmul_transpose_b_2x1280x1280_f16xf16xf32() {
        ...
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) alignment(64) offset(%c263488) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2x1280xf16>>
        ...
        %3 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) alignment(64) offset(%c273728) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2x1280xf32>>
        ...
        %5 = hal.interface.binding.subspan set(0) binding(3) type(storage_buffer) alignment(64) offset(%c268608) : !flow.dispatch.tensor<writeonly:tensor<2x1280xf16>>
