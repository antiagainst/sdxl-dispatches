  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @main$async_dispatch_9_contract_2x1280x2816_f16xf16xf32() {
        ...
        %c28928 = arith.constant 28928 : index
        %c0 = arith.constant 0 : index
        %c10240 = arith.constant 10240 : index
        %c6400 = arith.constant 6400 : index
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) alignment(64) offset(%c28928) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2816x2xf16>>
        ...
        %3 = hal.interface.binding.subspan set(0) binding(3) type(storage_buffer) alignment(64) offset(%c6400) : !flow.dispatch.tensor<writeonly:tensor<2x1280xf16>>
