  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @run_forward$async_dispatch_1488_conv_2d_nhwc_hwcf_2x128x128x640x3x3x640_f16() {
        ...
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) alignment(64) offset(%c115897728) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2x130x130x640xf16>>
        ...
        %2 = hal.interface.binding.subspan set(0) binding(2) type(storage_buffer) alignment(64) offset(%c63468928) : !flow.dispatch.tensor<writeonly:tensor<2x128x128x640xf16>>
