  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @main$async_dispatch_1361_conv_2d_nhwc_hwcf_2x128x128x320x3x3x320_f16xf16xf32() {
        ...
        %5 = hal.interface.binding.subspan set(0) binding(2) type(storage_buffer) alignment(64) offset(%c41943040) : !flow.dispatch.tensor<writeonly:tensor<2x320x128x128xf16>>
        ...
        %14 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : vector<2xi64>, lowering_config = #iree_codegen.lowering_config<tile_sizes = [[1, 1, 64, 64, 1, 1, 32]]>, strides = dense<1> : vector<2xi64>} ins(%6, %7 : tensor<2x130x130x320xf16>, tensor<3x3x320x320xf16>) outs(%13 : tensor<2x128x128x320xf32>) -> tensor<2x128x128x320xf32>
