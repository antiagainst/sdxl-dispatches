  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @main$async_dispatch_1327_generic_2x128x128x640_i64xi64xi64xi64xf16() {
        ...
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) alignment(64) offset(%c106223104) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2x640x64x64xf32>>
        ...
        %4 = hal.interface.binding.subspan set(0) binding(2) type(storage_buffer) alignment(64) offset(%c127194624) : !flow.dispatch.tensor<readwrite:tensor<2x130x130x640xf16>>
