  ...
  hal.executable.variant public @rocm_hsaco_fb target(<"rocm", "rocm-hsaco-fb", {mma_intrinsics = [#iree_gpu.mfma_layout<F16_16x16x16_F32>, #iree_gpu.mfma_layout<F16_32x32x8_F32>], target_arch = "gfx942", ukernels = "none"}>) {
    ...
    builtin.module {
      func.func @main$async_dispatch_272_conv_2d_nhwc_hwcf_2x32x32x1280x3x3x1280_f16xf16xf32() {
        ...
        %22 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : vector<2xi64>, lowering_config = #iree_codegen.lowering_config<tile_sizes = [[1, 1, 32, 256, 0, 0, 32], [0, 0, 0, 0, 1, 1, 0]]>, strides = dense<1> : vector<2xi64>} ins(%14, %15 : tensor<2x34x34x1280xf16>, tensor<3x3x1280x1280xf16>) outs(%21 : tensor<2x32x32x1280xf32>) -> tensor<2x32x32x1280xf32>
